...
!(function (t, e) {
        ...
        d = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (se(e, i)) {
                (a.rects = {
                  reference: ie(e, Et(i), "fixed" === a.options.strategy),
                  popper: gt(i),
                }),
                  (a.reset = !1),
  ...
  var re = oe(),
    ae = oe({ defaultModifiers: [It, te, jt, ut] }),
    le = oe({ defaultModifiers: [It, te, jt, ut, Jt, Xt, ee, Ct, Zt] }),
    ce = Object.freeze({
      __proto__: null,
      popperGenerator: oe,
      detectOverflow: Vt,
  ...
  const de = new RegExp("ArrowUp|ArrowDown|Escape"),
    he = g() ? "top-end" : "top-start",
    ue = g() ? "top-start" : "top-end",
    fe = g() ? "bottom-end" : "bottom-start",
    pe = g() ? "bottom-start" : "bottom-end",
    ge = g() ? "left-start" : "right-start",
  ...
  class ve extends M {
    ...
    show() {
      ...
      const t = ve.getParentFromElement(this._element),
      ...
      if (!I.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
        if (this._inNavbar) z.setDataAttribute(this._menu, "popper", "none");
          ...
          (this._popper = le(e, this._menu, i)),
    ...
    _getPlacement() {
      ...
      return t.classList.contains("dropup") ? (e ? ue : he) : e ? pe : fe;
    }
    _detectNavbar() {
    ...
    static dropdownInterface(t, e) {
      ...
      if (
        (i || (i = new ve(t, "object" == typeof e ? e : null)),
        "string" == typeof e)
      ) {
        if (void 0 === i[e]) throw new TypeError(`No method named "${e}"`);
        i[e]();
    ...
    static dataApiKeydownHandler(t) {
      ...
      if ("Escape" === t.key) return i().focus(), void ve.clearMenus();
      e || ("ArrowUp" !== t.key && "ArrowDown" !== t.key)
        ? e && "Space" !== t.key
          ? ve.getInstance(i())._selectMenuItem(t)
          : ve.clearMenus()
        : i().click();
    }
  }
  I.on(
    ...
    I.on(document, "click.bs.dropdown.data-api", ve.clearMenus),
    I.on(document, "keyup.bs.dropdown.data-api", ve.clearMenus),
    I.on(
      document,
      "click.bs.dropdown.data-api",
      '[data-bs-toggle="dropdown"]',
      function (t) {
        t.preventDefault(), ve.dropdownInterface(this);
      }
    ),
    m("dropdown", ve);
  const ye = () => {
    ...
    we = (t = ye()) => {
      Ee(),
        Te("body", "paddingRight", (e) => e + t),
        Te(
          ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
          "paddingRight",
          (e) => e + t
        ),
        Te(".sticky-top", "marginRight", (e) => e - t);
    },
    Ee = () => {
    ...
    Ae = () => {
      Le("body", "overflow"),
        Le("body", "paddingRight"),
        Le(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", "paddingRight"),
        Le(".sticky-top", "marginRight");
    },
    Le = (t, e) => {
      U.find(t).forEach((t) => {
  ...
  class Se extends M {
    ...
    _getConfig(t) {
      return (
        (t = { ...xe, ...z.getDataAttributes(this._element), ...t }),
        l("modal", t, Ce),
        t
      );
    }
  ...
  I.on(
    ...
    m("modal", Se);
  const Ne = { backdrop: !0, keyboard: !0, scroll: !1 },
  ...
  class Pe extends M {
    ...
    show(t) {
      ...
      (this._isShown = !0),
        ...
        this._backdrop.show(),
        this._config.scroll ||
          (we(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
        this._element.classList.add("show");
  ...
  I.on(
    ...
    function (t) {
      ...
      i && i !== e && Pe.getInstance(i).hide(),
        (v.get(e, "bs.offcanvas") || new Pe(e)).toggle(this);
    }
  ),
    I.on(window, "load.bs.offcanvas.data-api", () => {
      U.find(".offcanvas.show").forEach((t) =>
        (v.get(t, "bs.offcanvas") || new Pe(t)).show()
      );
    }),
    m("offcanvas", Pe);
  const Ie = new Set([
    ...
    Re = (t, e) => {
      ...
      if (e.includes(i))
        return (
          !Ie.has(i) || Boolean(Me.test(t.nodeValue) || He.test(t.nodeValue))
        );
  ...
  function Be(t, e, i) {
    ...
    for (let t = 0, i = o.length; t < i; t++) {
      ...
      const r = [].concat(...i.attributes),
        a = [].concat(e["*"] || [], e[n] || []);
      r.forEach((t) => {
        Re(t, a) || i.removeAttribute(t.nodeName);
      });
    }
    return n.body.innerHTML;
  }
  const We = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
  ...
  class Ye extends M {
    ...
    show() {
      ...
      v.set(o, this.constructor.DATA_KEY, this),
        ...
        this._popper
          ? this._popper.update()
          : (this._popper = le(this._element, o, this._getPopperConfig(c))),
        ...
        return "object" == typeof e && r(e)
          ...
          : void (this.config.html
              ? (this.config.sanitize &&
                  (e = Be(e, this.config.allowList, this.config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _getConfig(t) {
      ...
      return (
        ...
        t.sanitize && (t.template = Be(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          ...
          (e || (e = new Ye(this, i)), "string" == typeof t)
        ) {
  ...
  const qe = new RegExp("(^|\\s)bs-popover\\S+", "g"),
    ...
    Xe = { ...Ye.DefaultType, content: "(string|element|function)" },
    Qe = {
  ...
  class Ge extends Ye {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          (e || !/dispose|hide/.test(t)) &&
          (e || ((e = new Ge(this, i)), v.set(this, "bs.popover", e)),
          "string" == typeof t)
        ) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
          e[t]();
  ...
  class ti extends M {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        const e =
          ti.getInstance(this) || new ti(this, "object" == typeof t ? t : {});
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  I.on(window, "load.bs.scrollspy.data-api", () => {
    U.find('[data-bs-spy="scroll"]').forEach((t) => new ti(t));
  }),
    m("scrollspy", ti);
  class ei extends M {
    static get DATA_KEY() {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        const e = v.get(this, "bs.tab") || new ei(this);
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  I.on(
    ...
    function (t) {
      ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        d(this) || (v.get(this, "bs.tab") || new ei(this)).show();
    }
  ),
    m("tab", ei);
  ...
  class si extends M {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          (e || (e = new si(this, "object" == typeof t && t)),
          "string" == typeof t)
        ) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
          e[t](this);
