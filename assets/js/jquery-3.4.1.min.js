...
!(function (e, t) {
  ...
  (w.Callbacks = function (e) {
    ...
    w.extend({
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (W(e, a.done(s(n)).resolve, a.reject, !t),
  ...
  function Ie(e, t, n, r) {
    ...
    if (
      ...
      for (u = (s = w.map(ve(i, "script"), Pe)).length; f < p; f++)
        (l = i),
          f !== d &&
            ((l = w.clone(l, !0, !0)), u && w.merge(s, ve(l, "script"))),
          n.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, w.map(s, Re), f = 0; f < u; f++)
          (l = s[f]),
            he.test(l.type || "") &&
  ...
  function lt() {
    it &&
      (!1 === r.hidden && e.requestAnimationFrame
        ? e.requestAnimationFrame(lt)
        : e.setTimeout(lt, w.fx.interval),
      w.fx.tick());
  }
  function ct() {
    return (
      ...
      if (
        ...
        for (a = 0; (s = y[a++]) && !t.isPropagationStopped(); )
          (h = s),
            ...
            (p = (Q.get(s, "events") || {})[t.type] && Q.get(s, "handle")) &&
              p.apply(s, n),
            (p = c && s[c]) &&
              p.apply &&
              G(s) &&
  ...
  w.ajaxSetup({
    ...
    w.each(["top", "left"], function (e, t) {
      w.cssHooks[t] = ze(h.pixelPosition, function (e, n) {
        if (n)
          return (n = _e(e, t)), $e.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
